...
\subsection*{Pembelian barang oleh customer}
\featureflow{Customer menambah\\item ke cart}{Order Service\\\texttt{POST /api/orders}}{Insert PO, detail,\\stok keluar}{PO muncul\\untuk approval}

\subsection*{Riwayat pembelian customer}
\featureflow{Customer membuka\\riwayat PO}{Order Service\\\texttt{GET /api/companies/:id/orders}}{Query PO dan\\detail order}{Riwayat dan detail\\ditampilkan}
...
Screenshot berikut menjadi bukti visual bahwa Order Service sudah terhubung ke customer web dan endpoint detail purchase order.

\demoscreenshot{../screenshots/indratanaya-web-checkout-1.png}{Demo Indratanaya: customer web saat cart diisi sebelum checkout.}
\demoscreenshot{../screenshots/indratanaya-web-checkout-2.png}{Demo Indratanaya: checkout purchase order berhasil dari customer web.}
\demoscreenshot{../screenshots/indratanaya-web-riwayat-po.png}{Demo Indratanaya: riwayat pembelian customer setelah PO dibuat.}
\demoscreenshot{../screenshots/indratanaya-api-order-detail.png}{Demo Indratanaya: response endpoint detail order untuk membuktikan item PO tersimpan.}
